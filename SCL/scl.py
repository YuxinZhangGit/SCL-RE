...
from www import input_reader
from www.www_trainer import WWWTrainer
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--mode', default="train", type=str, help="Mode: 'train' or 'eval'")
    ...
    if args.mode == 'train':
        ...
        raise Exception("Mode not in ['train', 'eval', 'predict'], e.g. 'python www.py train ...'")